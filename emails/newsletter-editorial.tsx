        ...
        <Container style={{ maxWidth: "600px", margin: "0 auto" }}>
          ...
          <Section style={{ backgroundColor: "#1c2e1f", padding: "28px 32px" }}>
            <Text style={{ fontSize: "13px", color: "#8ab89a", margin: 0, fontFamily: "Arial, sans-serif", lineHeight: "1.6" }}>
              DairyCFO helps dairy industry professionals — creameries, co-ops, lenders, equipment dealers, hedger firms, and insurance agents — understand what's happening on the farms that drive the market.
              Written by someone who's been on both sides of the tank.
            </Text>
