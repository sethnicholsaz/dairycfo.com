        ...
        <Container style={{ maxWidth: "600px", margin: "0 auto", padding: "32px 0" }}>
          ...
          <Section style={{ padding: "20px 8px 32px" }}>
            <Text style={{ fontSize: "12px", color: "#8a9080", textAlign: "center", margin: 0, fontFamily: "Arial, sans-serif", lineHeight: "1.6" }}>
              DairyCFO helps dairy industry professionals — creameries, co-ops, lenders, equipment dealers, hedger firms, and insurance agents — understand the farms behind the market: prices, operations, and the decisions dairymen make every day.
            </Text>
