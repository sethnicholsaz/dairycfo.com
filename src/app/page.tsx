        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={number} className="p-7 rounded-2xl" style={{ background: "#fdfcf9", border: "1px solid #d8d2be" }}>
                <p className="text-5xl font-bold mb-5 leading-none" style={{ color: "#e8e4d8", fontFamily: "Georgia, serif", letterSpacing: "-0.04em" }}>{number}</p>
